...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.dayset_bg);
	...
	public void setMidTextColor(int midColor) {
	...
	public void setOtherTextColor(int otherColor) {
