...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	// Text settings
	private int otherTextColor = DEFAULT_TEXT_COLOR;
	private int midTextColor = DEFAULT_TEXT_COLOR;
	...
	public static List<TextView> currenTextView = new ArrayList<TextView>();

	public static List<TextView> getTextViewList() {
		return currenTextView;
	}
	...
	protected AbstractWheelTextAdapter(Context context, int itemResource, int itemTextResource) {
		...
		if (wheelView != null) {
			if (wheelView.getMidTextColor() != 0) {
				midTextColor = wheelView.getMidTextColor();
			}
			if (wheelView.getOtherTextColor() != 0) {
				otherTextColor = wheelView.getOtherTextColor();
			}
		}
	}
	...
	public View getItem(int index, View convertView, ViewGroup parent) {
		if (index >= 0 && index < getItemsCount()) {
			...
			// currenTextView.add(textView);
			if (wheelView != null) {
				if (index == wheelView.getCurrentItem()) {
					textView.setTextColor(wheelView.getMidTextColor());
				} else {
					textView.setTextColor(wheelView.getOtherTextColor());
				}
			} else {
