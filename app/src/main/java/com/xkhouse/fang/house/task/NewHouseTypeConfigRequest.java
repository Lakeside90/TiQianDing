...
/**
* @Description: 通过配置标识获取相应配置子选项列表 (新房--更多，价格，类型)  新房户型列表筛选
* @author wujian  
* @date 2015-9-18 下午1:48:46
 */
public class NewHouseTypeConfigRequest {

	private String TAG = "MapNewHouseConfigRequest";
	private RequestListener requestListener;

	private String siteId;	//站点ID
	//配置项Key[价格  类型  排序 楼盘特色  户型 面积  开发商  销售状态]
	private String configName = "PRICE_RANGE$PROPERTY_TYPE$ORDER$FEATURE_LIST$BEDROOM$AREA_TYPE$KAIFASHANG$SALE_STATE";
    ...
    public NewHouseTypeConfigRequest(String siteId, RequestListener requestListener) {
		this.siteId = siteId;
		this.requestListener = requestListener;
	}

	//星空宝佣金排序
	public NewHouseTypeConfigRequest(String siteId, String configName, RequestListener requestListener) {
		this.siteId = siteId; 
