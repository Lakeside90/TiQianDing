 ...
 */
public class NewHouseListView implements View.OnClickListener{
    ...
    public NewHouseListView(NewHouseListActivity context){
    ...
    private void initView() {
        rootView = LayoutInflater.from(mContext).inflate(R.layout.view_new_house_list, null);
    ...
    public void fillNewHouseData() {
        ...
        if(newHouseAdapter == null){
            newHouseAdapter = new NewHouseAdapter(mContext, newHouseList, adList, adIndex, mContext.getStartLatlng());
            house_listView.setAdapter(newHouseAdapter);
        }else {
            newHouseAdapter.setData(newHouseList, adList, adIndex, mContext.getStartLatlng());
        }
    }

    public void fillCacheData(){
        NewHouseListRequest request = new NewHouseListRequest();
        request.parseResult(AppCache.readNewHouseListJson(modelApp.getSite().getSiteId()));
