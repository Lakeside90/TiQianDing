...
/** 
 * @Description: 我的定制购房列表
 * @author wujian  
 * @date 2016-6-6 上午9:36:29
 */
public class MyCustomHouseListActivity extends AppBaseActivity {
	...
	protected void setContentView() {
		...
		setContentView(R.layout.activity_my_custom_house_list);
	}
	...
	private void initTitle() {
        ...
        tv_head_right.setText("定制需求");
		tv_head_title.setText("我的定制");
	...
	private void fillData() {
		...
		if(adapter == null){
			adapter = new CustomHouseAdapter(mContext, customHouses,true);
			house_listView.setAdapter(adapter);
		}else {
			adapter.setData(customHouses, true);
		}
	}
