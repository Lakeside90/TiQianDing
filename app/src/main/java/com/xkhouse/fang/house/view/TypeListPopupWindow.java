 ...
 */
public class TypeListPopupWindow extends PopupWindow{
...
//	private int childIndex = 0;   //当前选中的二级分类的索引
	 ...
	 */
	public TypeListPopupWindow(Context context, boolean isMoreType, 
	 ...
	 private void setListener() {
		 bg_lay.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				TypeListPopupWindow.this.dismiss();
			}
		});
