...
/**
* @Description: 获取各区域内出租房源总数 (租房地图找房) 
* @author wujian  
* @date 2015-9-28 下午3:21:10
 */
public class MapRentHouseCountRequest {

	private String TAG = "MapRentHouseCountRequest";
	...
	public MapRentHouseCountRequest(String siteId, RequestListener requestListener) {
		this.siteId = siteId;
	...
	public void doRequest(){
		...
		String url = StringUtil.getRequestUrl(Constants.RENT_HOUSE_COUNT, params);
		Logger.d(TAG, url);
