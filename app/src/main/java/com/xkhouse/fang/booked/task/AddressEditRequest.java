...
public class AddressEditRequest {
	...
	private String TAG = AddressEditRequest.class.getSimpleName();
	...
	public AddressEditRequest(String token, AddressInfo addressInfo, RequestListener requestListener) {
	...
	public void doRequest(){
		...
		params.put("address_id", addressInfo.getId());
		...
		String url = StringUtil.getRequestUrl(Constants.ADDRESS_EDIT, params);
		Logger.d(TAG, url); 
