...
* @date 2016-04-14
 */
public class JJRRentReleaseItemView implements OnClickListener{
	...
	public JJRRentReleaseItemView(JJRRentReleaseManageActivity context) {
        ...
        switch (v.getId()) {
            ...
            case R.id.refresh_txt:
                ...
                if (StringUtil.isEmpty(refreshIds)){
                    ...
                    refresh(refreshIds,ReleaseRefreshRequest.RENT_RELEASE );
                }
                break;
            ...
            case R.id.xiajia_txt:
                ...
                if (StringUtil.isEmpty(xiajiaIds)){
                    ...
                    xiajia(xiajiaIds, ReleaseRefreshRequest.RENT_RELEASE);
                }
                break;
