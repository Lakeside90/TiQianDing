...
/**
* @Description: 个人和经纪人删除房源(软删)
 * @author wujian
* @date 2016-04-21
 */
public class ReleaseDeleteRequest {
	...
	public ReleaseDeleteRequest(String id, String uid, String siteId, String type, RequestListener requestListener) {
	...
	public void doRequest(){
		...
		StringRequest request = new StringRequest(Request.Method.POST, Constants.USER_RELEASE_DELETE, new Listener<String>() {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String url = StringUtil.getRequestUrl(Constants.USER_RELEASE_DELETE, params);
                Logger.d(TAG, url);
