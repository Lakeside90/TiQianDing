...
* @date 2016-04-15
 */
public class JJRSellUnreleaseItemView implements OnClickListener{
	...
	public JJRSellUnreleaseItemView(JJRSellReleaseManageActivity context) {
        ...
        switch (v.getId()) {
            ...
            case R.id.shangjia_txt:
                ...
                if (StringUtil.isEmpty(shangJiaIds)){
                    ...
                    shangjia(shangJiaIds, ReleaseRefreshRequest.SELL_RELEASE);
                }
                break;
