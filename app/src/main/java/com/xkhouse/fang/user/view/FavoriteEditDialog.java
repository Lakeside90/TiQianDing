...
public class FavoriteEditDialog extends Dialog{

    public TextView delete_txt;
    public TextView clear_txt;
    public TextView cancel;
    Context context;
    private View rootView;
    public FavoriteEditDialog(Context context) {
        super(context);
        this.context = context;
    }

    public FavoriteEditDialog(Context context, boolean cancelable,
            OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        this.context = context;
    }

    public FavoriteEditDialog(Context context, int theme) {
        super(context, theme);
        this.context = context;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_favorite_edit);
        
        delete_txt = (TextView) findViewById(R.id.delete_txt);
