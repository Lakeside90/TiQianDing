...
public class QQLoginRequest {
	...
	private String TAG = "QQLoginRequest";
	private RequestListener requestListener;
	
	private String type;			//1 绑定已有的星空之家账号，没有的直接注册新账号2直接返回绑定后的信息
	private String openid;			//qq号码唯一对应标识openid
	private String profileImage;	//type=1的时候qq用户头像
	...
	public QQLoginRequest(String openid, String userId, String channelId, RequestListener requestListener) {
	...
	* @return void    返回类型
	...
	public void doCheckRequest(){
		...
		StringRequest request = new StringRequest(Method.POST,
				Constants.USER_QQ_LOGIN, new Listener<String>() {
				...
				})
		{
			...
			protected Map<String, String> getParams() throws AuthFailureError {
				...
				Logger.d(TAG, StringUtil.getRequestUrl(Constants.USER_QQ_LOGIN, params));
	...
	//qq绑定手机号
	public void doBindRequest(final String mobile, final String mobileCode,
			final String profileImage, String mobileMac){
