...
* @date 2016-04-25
 */
public class SellInEditRequest {

	private String TAG = "SellInEditRequest";
	private RequestListener requestListener;

    private SellInEditBean requestBean;
	private String code;	//返回状态
	private String msg;		//返回提示语


	public SellInEditRequest(SellInEditBean requestBean, RequestListener requestListener) {
	...
	public void setData(SellInEditBean requestBean) {
        this.requestBean = requestBean;
	}
	...
	public void doRequest(){
		...
		StringRequest request = new StringRequest(Request.Method.POST, Constants.USER_SELL_IN_EDIT, new Listener<String>() {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Logger.d(TAG, StringUtil.getRequestUrl(Constants.USER_SELL_IN_EDIT, params));
