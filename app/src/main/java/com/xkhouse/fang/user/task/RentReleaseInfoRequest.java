...
/**
* @Description: 获取  发布的出租房源
* @author wujian  
* @date 2016-04-25
 */
public class RentReleaseInfoRequest {

	private String TAG = "RentReleaseInfoRequest";
    ...
    private RentReleaseEditBean resultBean;
	private String code;	//返回状态
	private String msg;		//返回提示语


	public RentReleaseInfoRequest(String uid, String siteId, String houseId, RequestListener requestListener) {
	...
	public void doRequest(){
		...
		StringRequest request = new StringRequest(Request.Method.POST, Constants.USER_RENT_RELEASE_INFO, new Listener<String>() {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Logger.d(TAG, StringUtil.getRequestUrl(Constants.USER_RENT_RELEASE_INFO, params));
	...
	public void parseResult(String result) {
        ...
        try {
            ...
            if (jsonObject != null) {
                ...
                if(dataObj != null){
                    resultBean = new RentReleaseEditBean();
                    resultBean.setId(dataObj.optString("hId"));
                    ...
                    resultBean.setHireType(dataObj.optString("hireType"));
                    resultBean.setHireTypeName(dataObj.optString("zulingfangshi"));

                    resultBean.setHouseType(dataObj.optString("jishi"));
                    resultBean.setHouseLivingRoom(dataObj.optString("jiting"));
                    ...
                    resultBean.setHirePrice(dataObj.optString("hirePrice"));

                    resultBean.setPayType(dataObj.optString("payType"));
                    resultBean.setPayTypeName(dataObj.optString("zhifufangshi"));
                    ...
                    resultBean.setFacility(dataObj.optString("facility"));
