...
/**
* @Description: 微信第三方登录接口
* @author wujian  
* @date 2015-10-23 上午10:18:41
 */
public class WXLoginRequest {

	private String TAG = "WXLoginRequest";
	...
	public WXLoginRequest(String openid, String userId, String channelId, RequestListener requestListener) {
	...
	* @return void    返回类型
	...
	public void doCheckRequest(){
		...
		StringRequest request = new StringRequest(Method.POST,
				Constants.USER_WX_LOGIN, new Listener<String>() {
				...
				})
		{
			...
			protected Map<String, String> getParams() throws AuthFailureError {
				...
				Logger.d(TAG, StringUtil.getRequestUrl(Constants.USER_WX_LOGIN, params));
	...
	//微信绑定手机号
	public void doBindRequest(final String mobile, final String mobileCode,String mobileMac){
