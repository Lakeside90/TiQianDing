...
/**
* @Description: 经纪人出售房源管理--已删除
* @author wujian  
* @date 2016-04-15
 */
public class JJRSellDeleteItemView implements OnClickListener{
	...
	public JJRSellDeleteItemView(JJRSellReleaseManageActivity context) {
        ...
        switch (v.getId()) {
            ...
            case R.id.release_again_txt:
                ...
                if (StringUtil.isEmpty(releaseIds)){
                    ...
                    release(releaseIds, ReleaseAgainRequest.SELL_RELEASE);
                }
                break;
            ...
            case R.id.clear_txt:
                ...
                if (StringUtil.isEmpty(clearIds)){
                    ...
                    clear(clearIds, ReleaseClearRequest.SELL_RELEASE);
                }
                break;
    ...
    private void startSellReleaseListTask(int page){
        ...
        if (NetUtil.detectAvailable(context)) {
            if(sellReleaseListRequest == null){
                sellReleaseListRequest = new SellReleaseListRequest(modelApp.getUser().getUid(), modelApp.getSite().getSiteId(),"3",
