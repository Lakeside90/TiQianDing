...
/**
 * QQ账号重新绑定（账号之前绑定过QQ号，现在重新覆盖绑定）
 */
public class QQRebindRequest {

	private String TAG = "QQRebindRequest";
	private RequestListener requestListener;

	private String userName;     //用户名或手机号
	private String openid;     //qq用户标识

	private String code;	//返回状态
	private String msg;		//返回提示语
    private User user;

	public QQRebindRequest(String userName,String openid, RequestListener requestListener) {
	...
	public void doRequest(){
		...
		String url = StringUtil.getRequestUrl(Constants.USER_QQ_REBIND, params);
		Logger.d(TAG, url); 
