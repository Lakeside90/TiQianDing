...
/**
* @Description:  房源管理--求购列表
* @author wujian  
* @date 2016-04-20
 */
public class SellInListRequest {

	private String TAG = "SellInListRequest";
	...
	public SellInListRequest(String uId, String siteId,String type,
	...
	public void doRequest(){
		...
		StringRequest request = new StringRequest(Request.Method.POST, Constants.USER_SELL_IN_LIST, new Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String url = StringUtil.getRequestUrl(Constants.USER_SELL_IN_LIST, params);
                Logger.d(TAG, url);
