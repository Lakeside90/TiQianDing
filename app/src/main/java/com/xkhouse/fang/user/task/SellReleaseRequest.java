...
* @date 2016-04-19
 */
public class SellReleaseRequest {

	private String TAG = "SellReleaseRequest";
	private RequestListener requestListener;

	private String uid;
	private String siteId;
    private SellReleaseBean requestBean;
	private String code;	//返回状态
	private String msg;		//返回提示语


	public SellReleaseRequest(String uid, String siteId, SellReleaseBean requestBean, RequestListener requestListener) {
	...
	public void setData(String userName, String siteId, SellReleaseBean requestBean) {
		this.uid = userName;
		this.siteId = siteId;
        this.requestBean = requestBean;
	}
	...
	public void doRequest(){
		...
		StringRequest request = new StringRequest(Request.Method.POST, Constants.USER_SELL_RELEASE, new Listener<String>() {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Logger.d(TAG, StringUtil.getRequestUrl(Constants.USER_SELL_RELEASE, params));
