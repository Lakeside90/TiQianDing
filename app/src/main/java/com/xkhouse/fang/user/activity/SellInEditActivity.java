...
import com.xkhouse.fang.user.task.SellInEditRequest;
...
* @date 2016-04-12
 */
public class SellInEditActivity extends AppBaseActivity {
    ...
    private SellInEditBean sellInEditBean;
    ...
    protected void init() {
        ...
        sellInEditBean = (SellInEditBean) getIntent().getExtras().getSerializable("sellInEditBean");
     }
    ...
    private void fillData(){
        ...
        if(sellInEditBean.getAreaList() != null){
            StringBuffer sb = new StringBuffer();
            StringBuffer sbName = new StringBuffer();

            for (CommonType area:sellInEditBean.getAreaList()){
        ...
        if (!StringUtil.isEmpty(sellInEditBean.getPropertyTypeName())) {
            propertyType = new CommonType();
            propertyType.setId(sellInEditBean.getPropertyType());
            propertyType.setName(sellInEditBean.getPropertyTypeName());
            sell_type_txt.setText(sellInEditBean.getPropertyTypeName());
        }

        if(!StringUtil.isEmpty(sellInEditBean.getHouseType())){
            houseType = new CommonType();
            houseType.setId(sellInEditBean.getHouseType());
            houseType.setName(sellInEditBean.getHouseTypeName());
            house_type_txt.setText(sellInEditBean.getHouseTypeName());
        }

        if(!StringUtil.isEmpty(sellInEditBean.getArea_start())){
            space_min_txt.setText(sellInEditBean.getArea_start());
        }
        if(!StringUtil.isEmpty(sellInEditBean.getArea_end())){
            space_max_txt.setText(sellInEditBean.getArea_end());
        }

        if(!StringUtil.isEmpty(sellInEditBean.getPrice_start())){
            price_min_txt.setText(sellInEditBean.getPrice_start());
        }
        if(!StringUtil.isEmpty(sellInEditBean.getPrice_end())){
            price_max_txt.setText(sellInEditBean.getPrice_end());
        }

        if(!StringUtil.isEmpty(sellInEditBean.getFloor_start())){
            floor_min_txt.setText(sellInEditBean.getFloor_start());
        }
        if(!StringUtil.isEmpty(sellInEditBean.getFloor_end())){
            floor_max_txt.setText(sellInEditBean.getFloor_end());
        }

        if(!StringUtil.isEmpty(sellInEditBean.getTitle())){
            sellin_title_txt.setText(sellInEditBean.getTitle());
        }
        if(!StringUtil.isEmpty(sellInEditBean.getDetail())){
            sellin_remark_txt.setText(sellInEditBean.getDetail());
        }

        if(!StringUtil.isEmpty(sellInEditBean.getContacter())){
            sellin_name_txt.setText(sellInEditBean.getContacter());
        }
        if(!StringUtil.isEmpty(sellInEditBean.getContactPhone())){
            sellin_phone_txt.setText(sellInEditBean.getContactPhone());
        }
    ...
    private void startCommitTask(){
        if (NetUtil.detectAvailable(mContext)) {
            ...
            sellInEditBean.setArea(houseID);
            sellInEditBean.setPropertyType(propertyType.getId());
            sellInEditBean.setHouseType(houseType.getId());
            sellInEditBean.setArea_start(space_min_txt.getText().toString());
            sellInEditBean.setArea_end(space_max_txt.getText().toString());
            sellInEditBean.setPrice_start(price_min_txt.getText().toString());
            sellInEditBean.setPrice_end(price_max_txt.getText().toString());
            sellInEditBean.setFloor_start(floor_min_txt.getText().toString());
            sellInEditBean.setFloor_end(floor_max_txt.getText().toString());
            sellInEditBean.setTitle(sellin_title_txt.getText().toString());
            sellInEditBean.setDetail(sellin_remark_txt.getText().toString());
            sellInEditBean.setContacter(sellin_name_txt.getText().toString());
            sellInEditBean.setContactPhone(sellin_phone_txt.getText().toString());

            SellInEditRequest request = new SellInEditRequest(
                    sellInEditBean,
                    new RequestListener() {
                @Override
