...
import com.xkhouse.fang.user.view.JJRSellDeleteItemView;
import com.xkhouse.fang.user.view.JJRSellReleaseItemView;
import com.xkhouse.fang.user.view.JJRSellUnreleaseItemView;
...
public class JJRSellReleaseManageActivity extends AppBaseActivity {
    ...
    private JJRSellReleaseItemView releaseItemView;
    private JJRSellUnreleaseItemView unreleaseItemView;
    private JJRSellDeleteItemView deleteItemView;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (releaseItemView == null){
            releaseItemView = new JJRSellReleaseItemView(this);
        }
        sellItemViews.add(releaseItemView.getView());

        if (unreleaseItemView == null){
            unreleaseItemView = new JJRSellUnreleaseItemView(this);
        }
        sellItemViews.add(unreleaseItemView.getView());

        if (deleteItemView == null){
            deleteItemView = new JJRSellDeleteItemView(this);
        }
	...
	private void initTitle() {
        ...
        iv_head_right.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(JJRSellReleaseManageActivity.this, SellReleaseActivity.class));
            }
        });
