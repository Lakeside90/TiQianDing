...
import com.xkhouse.fang.user.entity.SellReleaseBean;
import com.xkhouse.fang.user.task.SellReleaseRequest;
...
* @date 2016-04-12
 */
public class SellReleaseActivity extends AppBaseActivity {
...
//        }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.sell_street_txt:
                Intent intent = new Intent(SellReleaseActivity.this, ReleaseStreetSearchActivity.class);
                Bundle data = new Bundle();
                data.putInt("activity", ReleaseStreetSearchActivity.SELL_ACTIVITY);
            ...
            case R.id.take_img:
                if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE)
                    ...
                    Intent photoIntent = new Intent(SellReleaseActivity.this, PhotoWallActivity.class);
                    Bundle photoData = new Bundle();
                    photoData.putInt("activity", PhotoWallActivity.SELL_ACTIVITY);
    ...
    private void commitForm(){
        SellReleaseBean requestBean = new SellReleaseBean();
        requestBean.setpId(area.getId());
        requestBean.setPropertyType(propertyType.getId());
        requestBean.setBeedroom(housetype_shi_txt.getText().toString());
        requestBean.setOffice(housetype_ting_txt.getText().toString());
        ...
        requestBean.setHouseArea(sell_space_txt.getText().toString());
        requestBean.setPrice(sell_price_txt.getText().toString());
        requestBean.setFitment(fitmentType.getId());
        requestBean.setOrientation(orientationType.getId());
        requestBean.setTitle(sell_title_txt.getText().toString());
        requestBean.setDetail(sell_remark_txt.getText().toString());
        requestBean.setContacter(sell_name_txt.getText().toString());
        requestBean.setContactPhone(sell_phone_txt.getText().toString());
