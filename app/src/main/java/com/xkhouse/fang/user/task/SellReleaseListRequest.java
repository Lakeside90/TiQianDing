...
/**
* @Description:  房源管理--出售列表
* @author wujian  
* @date 2016-04-20
 */
public class SellReleaseListRequest {

	private String TAG = "SellReleaseListRequest";
	...
	private ArrayList<XKRelease> sellList = new ArrayList<XKRelease>();


	public SellReleaseListRequest(String uId, String siteId,String type,
	...
	public void doRequest(){
		...
		StringRequest request = new StringRequest(Request.Method.POST, Constants.USER_SELL_RELEASE_LIST, new Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(Constants.SUCCESS_CODE.equals(code)){
                        	...
                        	data.putSerializable("sellList", sellList);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String url = StringUtil.getRequestUrl(Constants.USER_SELL_RELEASE_LIST, params);
                Logger.d(TAG, url);
            ...
            if (jsonObject != null) {
                ...
                if(newHouseArray != null && newHouseArray.length() > 0){
                	for(int i = 0; i < newHouseArray.length(); i++){
                        ...
                        rent.setId(rentJson.optString("sId"));
