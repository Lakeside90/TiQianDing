...
/**
* @Description: 经纪人出售房源管理--待发布
* @author wujian  
* @date 2016-04-15
 */
public class JJRRentUnreleaseItemView implements OnClickListener{
	...
	public JJRRentUnreleaseItemView(JJRRentReleaseManageActivity context) {
	...
	private void initView() {
		rootView = LayoutInflater.from(context).inflate(R.layout.view_jjr_sell_unrelease, null);
        ...
        shangjia_txt = (TextView) rootView.findViewById(R.id.shangjia_txt);
	...
	private void setListener(){
        ...
        shangjia_txt.setOnClickListener(this);
        ...
        switch (v.getId()) {
            ...
            case R.id.delete_txt:
                ...
                if (StringUtil.isEmpty(deleteIds)){
                    ...
                    delete(deleteIds, ReleaseRefreshRequest.RENT_RELEASE);
                }
                break;

            case R.id.shangjia_txt:
                String shangJiaIds = getSelectedReleaseIds();
                if (StringUtil.isEmpty(shangJiaIds)){
                    Toast.makeText(context, "请选择要上架的房源", Toast.LENGTH_SHORT).show();
                }else{
                    shangjia(shangJiaIds, ReleaseRefreshRequest.RENT_RELEASE);
                }
                break;
                    ...
                    public void sendMessage(Message message) {
                        ...
                        switch (message.what) {
                            ...
                            case Constants.SUCCESS_DATA_FROM_NET:
                                ...
                                release_count_txt.setText("当期" + message.getData().getString("daifabu") + "条房源"
