...
* @date 2016-04-19
 */
public class RentInRequest {

	private String TAG = "RentInRequest";
	private RequestListener requestListener;

	private String uid;
	private String siteId;
    private RentInBean requestBean;
	private String code;	//返回状态
	private String msg;		//返回提示语


	public RentInRequest(String uid, String siteId, RentInBean requestBean, RequestListener requestListener) {
	...
	public void setData(String userName, String siteId, RentInBean requestBean) {
		this.uid = userName;
		this.siteId = siteId;
        this.requestBean = requestBean;
	}
	...
	public void doRequest(){
		...
		StringRequest request = new StringRequest(Request.Method.POST, Constants.USER_RENT_IN, new Listener<String>() {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Logger.d(TAG, StringUtil.getRequestUrl(Constants.USER_RENT_IN, params));
