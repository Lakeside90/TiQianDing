...
public class FavoriteAddRequest {
	...
	public FavoriteAddRequest(String uId, String mId, String type, String siteId, RequestListener requestListener) {
	...
	public void doRequest(){
		...
		String url = StringUtil.getRequestUrl(Constants.USER_FAVORITE_ADD, params);
		Logger.d(TAG, url); 
