 ...
 */
public class FavRentHouseAdapter extends BaseAdapter {

	private Context context;
	private ArrayList<FavHouse> rentHouseList;
	private DisplayImageOptions options;
	private ItemLongClickListener clickListener;
	
	public FavRentHouseAdapter(Context context, ArrayList<FavHouse> rentHouseList,
	...
	public void setData(ArrayList<FavHouse> rentHouseList){
		this.rentHouseList = rentHouseList;
	...
	@Override
	public int getCount() {
		return rentHouseList.size();
	}

	@Override
	public Object getItem(int position) {
		return rentHouseList.get(position);
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = LayoutInflater.from(context).inflate(R.layout.item_fav_rent_house_list, null);
		...
		FavHouse house = rentHouseList.get(position);
		...
		holder.house_title_txt.setText(house.getHiretitle());
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				bundle.putString("projectId",  rentHouseList.get(position).getProjectId());
				bundle.putString("projectName", rentHouseList.get(position).getProjectName());
