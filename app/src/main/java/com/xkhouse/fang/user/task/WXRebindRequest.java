...
/**
 * 微信账号重新绑定（账号之前绑定过微信账号，现在重新覆盖绑定）
 */
public class WXRebindRequest {

	private String TAG = "WXRebindRequest";
	...
	public WXRebindRequest(String userName, String openid, RequestListener requestListener) {
	...
	public void doRequest(){
		...
		String url = StringUtil.getRequestUrl(Constants.USER_WX_REBIND, params);
		Logger.d(TAG, url); 
