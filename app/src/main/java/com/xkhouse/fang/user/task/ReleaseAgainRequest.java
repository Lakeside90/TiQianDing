...
* @date 2016-04-22
 */
public class ReleaseAgainRequest {

	private String TAG = "ReleaseAgainRequest";
	...
	public ReleaseAgainRequest(String id, String uid, String siteId, String type, RequestListener requestListener) {
	...
	public void doRequest(){
		...
		StringRequest request = new StringRequest(Request.Method.POST, Constants.USER_RELEASE_AGAIN, new Listener<String>() {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String url = StringUtil.getRequestUrl(Constants.USER_RELEASE_AGAIN, params);
                Logger.d(TAG, url);
